...
public class Main_25304 {
	...
	private static void solve() throws Exception {
		...
		int numberOfGoodsTypes = Integer.parseInt(br.readLine());
		int totalCost = 0;
		
		for(int i = 0; i < numberOfGoodsTypes; i++) {
			String[] s = br.readLine().split(" ");
			totalCost += Integer.parseInt(s[0]) * Integer.parseInt(s[1]);
		}
