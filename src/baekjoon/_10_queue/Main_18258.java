...
public class Main_18258 {
	...
	private static void front(LinkedList<Integer> queue) {
		if(queue.size() == 0) {
			sb.append(-1 + "\n");
		}else {
	...
	private static void empty(LinkedList<Integer> queue) {
		if(queue.size() == 0) {
			sb.append(1 + "\n");
		}else {
			sb.append(0 + "\n");
	...
	private static void size(LinkedList<Integer> queue) {
		sb.append(queue.size() + "\n");
	}

	private static void pop(LinkedList<Integer> queue) {
		if(queue.size() == 0) {
			sb.append(-1 + "\n");
		}else {
	...
	private static void push(LinkedList<Integer> queue, String str) {
